...
abstract class SoopkomonRepository {
  ...
  Future<List<SoopkomonTemplate>> getSoopkomonTemplates({AppLocale locale = AppLocale.ko});
  ...
  Future<List<String>> getParkTitlesByPetId(String petId, {AppLocale locale = AppLocale.ko});
